            ...
            <div className="mb-md-5  ">
             ...
             <br/> <label className="form-label">Email</label>
              <div className="form-outline form-white mb-4">
                <input type="email" id="typeEmailX" className="form-control form-control-lg" name='email' placeholder='enter your email' value={logindetail.email} onChange={(e)=>handleChange(e,'email')} />
              
              </div>
              <label className="form-label" >Password</label>
              <div className="form-outline form-white mb-4">
                <input type="password" id="typePasswordX" className="form-control form-control-lg" name='password' placeholder='enter your password' value={logindetail.password} onChange={(e)=>handleChange(e,'password')}/>
